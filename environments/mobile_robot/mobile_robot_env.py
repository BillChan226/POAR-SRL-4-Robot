...
class MobileRobotGymEnv(SRLGymEnv):
    ...
    def __init__(self, urdf_root=pybullet_data.getDataPath(), renders=False, is_discrete=True,
        ...
        #record_states = True
        #self.states_reward_logger = None
        #if record_states:
        #    self.states_reward_logger = LogRLStates('/home/tete/work/robotics-rl-srl/SRL_States_logs/')
        if record_data:
    ...
    def reset(self):
        ...
        #if self.states_reward_logger is not None:
        #    self.states_reward_logger.reset(self._observation, self._observation)
    ...
    def step(self, action):
        ...
        #if self.states_reward_logger is not None:
        #    self.states_reward_logger.step(self._observation, self._observation, action, reward, done)
    ...
    def render(self, mode='human', close=False):
        ...
        rgb_array = rgb_array.reshape(RENDER_WIDTH, RENDER_WIDTH, -1)
        #print("SHHHHHHP", np.shape(rgb_array))
