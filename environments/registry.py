...
from environments.JAKA.jakazu import JakaButtonZuGymEnv
from environments.jaka_gym.obstacle_gym_env import JakaButtonObsGymEnv
from environments.jaka_gym.continous_obstacle import ContinousObsGymEnv
...
registered_env = {
    ...
    "JakaButtonGymZuEnv-v0":            (JakaButtonZuGymEnv, SRLGymEnv, PlottingType.PLOT_3D, ThreadingType.PROCESS),
    "JakaButtonObsGymEnv-v0":         (JakaButtonObsGymEnv, SRLGymEnv, PlottingType.PLOT_3D, ThreadingType.PROCESS),
    "ContinousObsGymEnv-v0":          (ContinousObsGymEnv, SRLGymEnv, PlottingType.PLOT_3D, ThreadingType.PROCESS),
}
